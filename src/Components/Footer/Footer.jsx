...
const Footer = () => {
  ...
  const text =
  "The Word of Faith Bible Institute (WOFBI) is the Leadership and Training arm of the Living Faith Church Worldwide. Established on the 1st of September, 1986 in Kaduna, Nigeria, over 50,000 students have graduated from the numerous WOFBI Campuses all across Nigeria and the World.";

  return (
    <>
      <section className="footermain text-left w-full bg-blue-500 overflow-auto">
        <div className="footer text-left flex flex-col lg:flex-row w-full px-[79.5px] pt-[20px] lg:pb-[20px] bg-blue-500 gap-[100px] text-[14px]">
          <div className="left flex flex-col lg:flex-row gap-[100px] w-full">
            ...
            <div id="contact" className="flex flex-col w-full lg:w-auto">
              ...
              <div className="textAndIcon w-full max-w-[326px] mt-[10px]">
              <p>
